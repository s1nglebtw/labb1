...
### Список источников
[python function документация](https://docs.python.org/3/library/functions.html)
# lab_4
## Задача 1
**Результат**
...
### Список источников
[PIL библиотека документация](https://hugovk-pillow.readthedocs.io/en/stable/index.html)

[python functools документация](https://docs.python.org/3/library/functools.html)
# lab_6
## Задача 1
**Результат**
...
[python guizero документация](https://pypi.org/project/guizero/)
